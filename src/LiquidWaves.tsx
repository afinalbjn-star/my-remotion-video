...
export const LiquidWaves: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ backgroundColor: '#0a0015' }}>
            ...
            {/* Noise texture untuk memaksa bitrate lebih tinggi dan memberikan kesan 4K yang lebih organik */}
            <div style={{
                position: 'absolute',
                inset: 0,
                opacity: 0.12, // Menaikkan intensitas noise untuk menambah detail visual (dan ukuran file)
