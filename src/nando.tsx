...
export const Nando: React.FC = () => {
	...
	return (
		<AbsoluteFill className="bg-slate-950 flex flex-col items-center justify-center p-20" style={{ fontSize: '2rem' }}>
			...
			{/* Chart Container - Enlarged for 2.5K */}
			<div className="z-10 w-full max-w-6xl h-[600px] flex items-end justify-between gap-8 px-10 relative">
				...
				{
					data.map((item, i) => {
						const [startColor, endColor] = item.color.split(' ');
						const delay = i * 15;
								...
								<div className="relative w-full flex-1 flex items-end group bg-slate-900/40 rounded-xl p-1 shadow-inner border border-white/5">
									<div
										...
										style={{
											...
											boxShadow: `0 0 40px -10px ${startColor}88`
										}}
									>
										{/* Shine & Depth */}
